                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><? = $hasil->tlpn  ?></td>
                        <td>
                          <a href="<?= base_url()  ?>home/edit><?= $hasil->kd_agt  ?>"  class="btn btn-sm btn-primary">Edit</a>
                          <a href="<?= base_url()  ?>home/edit><?= $hasil->kd_agt  ?>"  class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
