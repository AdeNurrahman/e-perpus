            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="container">
                  <div class="row mt-3">
                    <div class="col-md-3">
                      <a href="<?= base_url() ?>home/v_tambah" class="btn btn-success">Tambah Buku</a>
                    </div>
                  </div>
                </div>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $hasil->stok;  ?></td>
                        <td><?= $hasil->th_penerbit;  ?></td>
                        <td><?= $hasil->id_kategori;  ?></td>
                        <td>
                          <a href="<?= base_url()  ?>home/edit><?= $hasil->kd_buku  ?>"  class="btn btn-sm btn-primary">Edit</a>
                          <a href="<?= base_url()  ?>home/hapus><?= $hasil->kd_buku  ?>"  class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin?');">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
